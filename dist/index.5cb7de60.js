...
const gameBoard = function() {
    ...
    const boardHeight = 3;
    function initBoard() {
        for(let i = 0; i < boardLength; i++)for(let j = 0; j < boardHeight; j++)board[i][j] = null;
    }
    function getBoard() {
        return board;
    }
...
const displayController = function() {
    const crossElement = `<img class="cross-image" src="${new URL(require("bc2d80d9310cca3c"))}" alt="X">`;
    const circleElement = `<img class="circle-image" src="${new URL(require("f4877ee28ccd39de"))}" alt="O">`;
    const renderBoard = ()=>{
        ...
        for(let i = 0; i < 3; i++)for(let j = 0; j < 3; j++){
            if (board[i][j] == 'O') gameBoardElement.children[i].children[j].innerHTML = circleElement;
            else if (board[i][j] == 'X') gameBoardElement.children[i].children[j].innerHTML = crossElement;
            else gameBoardElement.children[i].children[j].innerHTML = '';
    ...
    const resetWinner = ()=>{
        ...
        if (winnerElement != null) winnerElement.remove();
    };
    return {
        renderBoard,
        renderWinner,
...
function Player(name) {
    ...
    const setMarker = (inputMarker)=>{
        if (inputMarker == 'O' || inputMarker == 'X') marker = inputMarker;
    };
    const getMarker = ()=>{
        return marker;
    };
...
function Game(player1, player2) {
    ...
    const changeTurn = ()=>{
        if (currentTurnPlayer == player1) currentTurnPlayer = player2;
        else currentTurnPlayer = player1;
    };
    const checkWinner = ()=>{
...
},{"bc2d80d9310cca3c":"1gHEy","f4877ee28ccd39de":"4Fgnp"}],"1gHEy":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('cBz4w') + "times.eb65cc06.svg";
...
},{}],"4Fgnp":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('cBz4w') + "circle.4f544881.svg";

},{"./helpers/bundle-url":"8YnfL"}]},["8Ye98","6cF5V"], "6cF5V", "parcelRequire1ecf")
